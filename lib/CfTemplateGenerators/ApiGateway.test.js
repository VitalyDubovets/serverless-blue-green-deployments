...
describe('ApiGateway', () => {
  ...
  describe('.replaceMethodUriWithAlias', () => {
    it('replaces the method URI with a function alias ARN', () => {
      ...
      const uriWithAwsVariables = { Ref: functionAlias }
      const expected = _.set('Properties.Integration.Uri', uriWithAwsVariables, apiGatewayMethod)
  ...
  describe('.replaceV2IntegrationUriWithAlias', () => {
    it('replaces the integration URI with a function alias ARN', () => {
      const functionAlias = 'TheFunctionAlias'
      const uriWithAwsVariables = { Ref: functionAlias }
      const expected = _.set('Properties.IntegrationUri', uriWithAwsVariables, apiGatewayV2Method)
